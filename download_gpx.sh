...
dropbox="https://www.dropbox.com/scl/fo/8z94chsvow2jdsiqp671y/AE_En7cxUwPiObSOGeiH8vk?rlkey=lti74t6t38wog9h9uo3v2wzqk&st=6xvo4a6g&dl=0"
...
if [[ -f  track_data/salidas_campo_gpx.zip ]];then
  unzip track_data/salidas_campo_gpx.zip -d track_data/ -u
